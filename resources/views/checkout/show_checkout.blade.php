...
<section id="cart_items">
    <div class="container">
        ...
        <div class="register-req">
            <p>Vui lòng đăng nhập hoặc đăng ký để thanh toán</p>
        </div><!--/register-req-->
                    ...
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            <form method="POST">
                                ...
                                <input type="text" name="shipping_adress" class="shipping_adress" placeholder="Địa chỉ">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    @endphp
                     <tr>
                        <td class="cart_product">
                            <a href=""><img src="{{asset('public/upload/product/'.$cart['product_image'])}}" width="100" alt="{{$cart['product_name']}}"/></a>
                        </td>
                    ...
                    <td colspan="2">
                        ...
                        @if(Session::get('fee'))
                        <li><a class="cart_quantity_delete" href="{{url('/del-fee')}}"><i class="fa fa-times"></i>
                        </a>Phí vận chuyển <span>{{number_format(Session::get('fee'),0,',','.')}}đ</span></li>
