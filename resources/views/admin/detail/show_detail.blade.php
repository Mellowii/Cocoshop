              ...
              <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                      <a href=""><img src="{{URL::to('public/frontend/images/images/pricing.png')}}" alt=""></a>
                      <a href=""><img src="{{URL::to('public/frontend/images/images/logo.jpg')}}" alt=""></a>
                      <a href=""><img src="{{URL::to('public/frontend/images/images/logo.jpg')}}" alt=""></a>
                    </div>
                    <div class="item">
                      <a href=""><img src="{{URL::to('public/frontend/images/images/logo.jpg')}}" alt=""></a>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <span>
                ...
                <label>Số lượng:
                <input name="qty" type="number" min="1" class="cart_product_qty_{{$value->product_id}}"  value="1" /> </label>
